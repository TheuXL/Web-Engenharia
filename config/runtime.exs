...
if config_env() == :prod do
  ...
  # Desafio/local Docker: manter fluxo de auth funcional sem SMTP externo.
  # O phx.gen.auth envia emails de confirmação/login; com adapter local
  # precisamos habilitar o storage local também em prod runtime.
